...
create policy "Board records club ledger" on public.club_finance_transactions for insert with check(public.can_manage_club(club_id) and created_by=auth.uid());
